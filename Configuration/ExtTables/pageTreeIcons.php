...
$extIconPath = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath( $_EXTKEY ) . 'Resources/Public/Icons/PageTree/';
...
$TCA[ 'pages' ][ 'columns' ][ 'module' ][ 'config' ][ 'items' ][] = array( 'Application web', 'appl-intnt', $extIconPath . 'applications-internet.png' );
...
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-filter', $extIconPath . 'view-filter.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-code-class', $extIconPath . 'code-class.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-code-cntxt', $extIconPath . 'code-context.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-cam-photo', $extIconPath . 'camera-photo.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-media-dvd', $extIconPath . 'media-optical-recordable.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-speaker', $extIconPath . 'speaker.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-call-start', $extIconPath . 'call-start.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-call-stop', $extIconPath . 'call-stop.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-dlg-cancel', $extIconPath . 'dialog-cancel.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-dlg-close', $extIconPath . 'dialog-close.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-dlg-ok', $extIconPath . 'dialog-ok-apply.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-dlg-passwd', $extIconPath . 'dialog-password.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-help', $extIconPath . 'help-hint.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-favorite', $extIconPath . 'emblem-favorite.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-important', $extIconPath . 'emblem-important.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-highscore', $extIconPath . 'games-highscores.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-roll', $extIconPath . 'roll.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-appl-dev', $extIconPath . 'applications-development.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-chronom', $extIconPath . 'chronometer.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-configure', $extIconPath . 'configure.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-bomb', $extIconPath . 'edit-bomb.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-home', $extIconPath . 'home-mdk.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-prefrncs', $extIconPath . 'preferences-system.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-sec-high', $extIconPath . 'security-high.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-sec-low', $extIconPath . 'security-low.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-sec-mdm', $extIconPath . 'security-medium.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-stat-unknw', $extIconPath . 'status_unknown.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-trash', $extIconPath . 'user-trash.png' );

TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-flg_black', $extIconPath . 'flag-black.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-flg_blue', $extIconPath . 'flag-blue.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-flg_green', $extIconPath . 'flag-green.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-flg_red', $extIconPath . 'flag-red.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-flg_yellow', $extIconPath . 'flag-yellow.png' );

TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_blue', $extIconPath . 'folder-blue.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_bkmrk', $extIconPath . 'folder-bookmark.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_brown', $extIconPath . 'folder-brown.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_cyan', $extIconPath . 'folder-cyan.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_dev', $extIconPath . 'folder-development.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_docs', $extIconPath . 'folder-documents.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_down', $extIconPath . 'folder-downloads.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_fvrts', $extIconPath . 'folder-favorites.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_green', $extIconPath . 'folder-green.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_imprtt', $extIconPath . 'folder-important.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_locked', $extIconPath . 'folder-locked.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_orange', $extIconPath . 'folder-orange.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld', $extIconPath . 'folder.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_red', $extIconPath . 'folder-red.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_remote', $extIconPath . 'folder-remote.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_sound', $extIconPath . 'folder-sound.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_tar', $extIconPath . 'folder-tar.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_txt', $extIconPath . 'folder-txt.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_video', $extIconPath . 'folder-video.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_violet', $extIconPath . 'folder-violet.png' );
TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-fld_yellow', $extIconPath . 'folder-yellow.png' );

TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-jquery', $extIconPath . 'jQuery.gif' );

TYPO3\CMS\Backend\Sprite\SpriteManager::addTcaTypeIcon( 'pages', 'contains-library', $extIconPath . 'library.png' );
